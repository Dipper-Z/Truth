...
try {
	...
	const Loader = function(win, document, ignoreParam) {
		...
		var last_release_ts = "2024-04-18 12:49:55";  // Last time a file was released from split test
		...
		// List of rtp files
		var rtp_files = {"28526":"latest","28527":"3.5.0-viewability","28528":"3.4.1"};

		// List of custom tags
		var rtp_default_tags = {"latest":["28526"],"3.5.0":["28527"],"3.4.1":["28528"]};

		// Traffic Percentages
		var traffic_percentages = {"28526":0.9,"28527":0.1,"28528":0};
...
window.properSpecialOps.floor_key = "other-desktop-chrome"
window.properSpecialOps.country='CN';
window.properSpecialOps.region='HA';
